...
type AMIConfig struct {
	...
	RawAMIENASupport        trilean.Trilean   `mapstructure:"ena_support"`
	AMISriovNetSupport      bool              `mapstructure:"sriov_support"`
	AMIForceDeregister      bool              `mapstructure:"force_deregister"`
	AMIForceDeleteSnapshot  bool              `mapstructure:"force_delete_snapshot"`
	RawAMIEncryptBootVolume trilean.Trilean   `mapstructure:"encrypt_boot"`
...
func (c *AMIConfig) Prepare(accessConfig *AccessConfig, ctx *interpolate.Context) []error {
	...
	c.AMIENASupport = trilean.ToBoolPointer(c.RawAMIENASupport)
	c.AMIEncryptBootVolume = trilean.ToBoolPointer(c.RawAMIEncryptBootVolume)
